...
describe('es', function () {
	...
	it('given sample docs', function (next) {
		...
		doc = [
			{
				thread: {
					_id: tid = l.mongo.getNewThreadId(), categoryId: 101, created: new Date(2000, 1, 1),
					title: 'hello world'
				},
				post: {
					_id: l.mongo.getNewPostId(), created: new Date(2000, 1, 1),
			...
			},
			{
				...
				post: {
					_id: l.mongo.getNewPostId(), created: new Date(2000, 1, 2),
					writer: 'snowman', text: 'apple pine orange'
				}
			},
			{
				thread: {
					_id: l.mongo.getNewThreadId(), categoryId: 101, created: new Date(2000, 2, 1),
					title: '안녕하세요. 한글 테스트'
				},
				post: {
					_id: l.mongo.getNewPostId(), created: new Date(2000, 2, 1),
					writer: '홍길동', text: '둥글게 네모나게 붉게 파랗게'
				}
			},
			{
				thread: {
					_id: l.mongo.getNewThreadId(), categoryId: 101, created: new Date(2000, 3, 1),
					title: '안녕할까요. 한글 테스트'
				},
				post: {
					_id: l.mongo.getNewPostId(), created: new Date(2000, 3, 1),
					writer: '개똥이', text: '둥글게 네모나게'
				}
			},
			{
				thread: {
					_id: l.mongo.getNewThreadId(), categoryId: 101, created: new Date(2000, 4, 1),
					title: '강물엔 유람선이 떠있고'
				},
				post: {
					_id: l.mongo.getNewPostId(), created: new Date(2000, 4, 1),
